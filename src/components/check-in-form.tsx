...
export function CheckInForm() {
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] h-[calc(100vh-3.5rem)] snap-y snap-mandatory overflow-y-scroll overflow-x-hidden">
      <Form {...form}>
        <form
        ...
        >
          <StepSection ref={sensationRef}>
            <div className="flex flex-col items-center justify-start py-8 text-center relative overflow-y-auto h-full">
              ...
              <div className="relative z-10 w-full px-4">
                <h1 className="font-extrabold text-3xl sm:text-5xl md:text-6xl tracking-tighter text-foreground mb-2 sm:mb-4">Where Do You Feel It?</h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-4 sm:mb-6 md:mb-8">
            ...
            <div className="absolute bottom-4 sm:bottom-6 left-0 right-0 flex justify-center pointer-events-none">
              <Button type="button" size="icon" variant="ghost" className="rounded-full h-12 w-12 animate-bounce pointer-events-auto" onClick={() => scrollTo(emotionRef)}>
                <ArrowDown />
              </Button>
            </div>
          </StepSection>
            ...
            <div className="flex flex-col items-center justify-center text-center h-full relative">
              ...
              <div className="relative z-10 flex flex-col h-full w-full">
                <div className="text-center pt-8">
                  <h1 className="font-extrabold text-3xl sm:text-5xl md:text-6xl tracking-tighter text-foreground mb-2 sm:mb-4">How Do You Feel?</h1>
                  <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-4 sm:mb-6 md:mb-8">
                    First, pick a broad category from the outer wheel, then a specific feeling from the inner wheel.
                  </p>
                </div>
                <div className="flex-1 grid md:grid-cols-2 gap-2 md:gap-8 items-start md:items-center overflow-y-auto md:overflow-hidden px-4">
                  <div className="relative w-full h-full max-w-[250px] sm:max-w-[400px] md:max-w-[500px] max-h-[250px] sm:max-h-[400px] md:max-h-[500px] mx-auto aspect-square">
                    <FormField
                      control={form.control}
                      name="emotion"
                      render={({ field }) => (
          ...
          <StepSection ref={thoughtRef}>
            <div className="flex flex-col items-center justify-center h-full text-center relative">
              ...
              <div className="relative z-10 w-full px-4">
                <h1 className="font-extrabold text-3xl sm:text-5xl md:text-6xl tracking-tighter text-foreground mb-2 sm:mb-4">
                  What's On Your Mind?
                </h1>
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-4 sm:mb-6 md:mb-8">
                  Observe your thoughts without judgment. What patterns do you notice? This helps in understanding your mental habits.
                </p>
                <Card className="w-full max-w-2xl mx-auto bg-background/80 backdrop-blur-sm rounded-2xl flex flex-col max-h-[70vh]">
          ...
          <StepSection ref={copingRef}>
            <div className="flex flex-col items-center justify-start py-8 h-full relative overflow-y-auto">
              ...
              <div className="relative z-10 w-full px-4 pb-32 max-w-4xl mx-auto">
            ...
            <div className="absolute bottom-4 sm:bottom-6 left-0 right-0 flex flex-col sm:flex-row justify-center sm:justify-between gap-3 px-4 sm:px-6 pointer-events-none">
              <Button
                type="submit"
                size="lg"
                variant="outline"
                disabled={form.formState.isSubmitting}
                className="rounded-full px-8 w-full sm:w-auto pointer-events-auto"
              >
                Skip & Complete
              </Button>
              <Button
